...
} elseif ($_instance->childHasBeenRendered('KFtcMBk')) {
    $componentId = $_instance->getRenderedChildComponentId('KFtcMBk');
    $componentTag = $_instance->getRenderedChildComponentTagName('KFtcMBk');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('KFtcMBk');
} else {
    $response = \Livewire\Livewire::mount('profile-cover', ['userId' => ''.e($userId).'','profileId' => ''.e($profileId).'']);
    $html = $response->html();
    $_instance->logRenderedChild('KFtcMBk', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
